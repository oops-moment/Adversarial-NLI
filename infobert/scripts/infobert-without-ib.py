...
def setup_conda_environment():
    print("Creating and activating Conda environment...")
...
# Step 2: Clone the InfoBERT repository

# Step 3: Copy ANLI data into the InfoBERT project
def copy_anli_data():
    print("Copying ANLI data...")
    src_path = "/kaggle/input/anli-data/anli_data"
...
def change_to_infobert_directory():
    print("Changing to InfoBERT directory...")
...
def change_to_anli_directory():
    print("Changing to ANLI directory...")
    os.chdir('/kaggle/working/InfoBERT/ANLI')

# Step 7: Run the setup script and execute the experiment
def run_experiment():
